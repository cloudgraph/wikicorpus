...
/**
 * hadoop jar /home/lib/wikicorpus-index-0.5.1.jar org.cloudgraph.examples.corpus.index.DependencyDriver -libjars ${LIBJARS} 
 */
public class WordDependencyDriver {
	private static Log log = LogFactory.getLog(WordDependencyDriver.class);
	...
	private static void printUsage() {
		System.err.println("Usage: " + "hadoop jar /home/lib/wikicorpus-index-0.5.1.jar " + 
	        WordDependencyDriver.class.getName() + " -libjars ${LIBJARS}");
	}
	...
	public static void runJob(Configuration conf) throws IOException {
		...
		Job job = new Job(conf, WordDependencyDriver.class.getSimpleName());
		job.setJarByClass(WordDependencyDriver.class);

		Query queryIn = createInputQuery();
	    GraphMapReduceSetup.setupGraphMapperJob(queryIn,
	    		WordDependencyMapper.class, Text.class,
				IntWritable.class, job);
		job.setNumReduceTasks(1);
		job.setReducerClass(WordDependencyReducer.class);
