...
*/
public class WikiPageParserDriver {

	/*
	 * Prints usage without error message
	 */
	private static void printUsage() {
		System.err.println("Usage: " + WikiPageParserDriver.class.getSimpleName());
	}
	/*
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			Logger.getLogger(WikiPageParserDriver.class.getName()).log(
	...
	public static void runJob(Configuration conf, String input, String output) throws IOException {
		...
		Job job = new Job(conf, WikiPageParserDriver.class.getSimpleName());

		FileInputFormat.setInputPaths(job, input);
		job.setJarByClass(WikiPageParserDriver.class);
		job.setMapperClass(WikiPageParserMapper.class);
